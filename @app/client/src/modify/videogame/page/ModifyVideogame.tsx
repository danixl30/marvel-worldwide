...
import {
    actorRoles,
    modifyVideogameLogic,
    videogameTypes,
} from '../logic/modify.videogame'
...
export default function ModifyVideogamePage() {
    ...
    const {
        ...
        modifyVideogameApplicationService(
                    ...
                    <Card css={{ padding: 30, alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <Col>
                                ...
                                <Spacer x={1} />
                                <Input
                                    value={platformInput.state.value}
                                    onChange={(e) =>
                                        platformInput.setState(e.target.value)
                                    }
                                    helperColor="error"
                                    placeholder=""
                                    label="Platform"
                                ...
                                <Spacer x={1} />
                                <Button
                                    disabled={!platformInput.state.value}
                                    onPress={() =>
                                        addPlatform(platformInput.state.value)
                                    }
                                >
                                    Add Platform
                                </Button>
                                <Spacer x={1} />
                                {platforms.value.map((e) => (
                                    <Card
                                        css={{
                                            padding: 10,
                                            alignItems: 'center',
