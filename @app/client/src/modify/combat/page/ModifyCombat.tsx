...
import { modifyCombatLogic } from '../logic/modify.combat'
...
export default function ModifyCombat() {
    ...
    const {
        ...
        modifyCombatApplicationService(
                    ...
                    <Card css={{ padding: 30, alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <Col>
                                ...
                                {charactersBase.value
                                    .filter(
                                        (e) =>
                                            !charactersToDelete.value.find(
                                                (cha) => cha.id === e.id,
                                            ),
                                    )
                                    .map((character) => (
