...
import { actorRoles, modifyMovieLogic, movieTypes } from '../logic/modify.movie'
...
export default function ModifyMoviePage() {
                    ...
                    <Card css={{ padding: 30, alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <Col>
                                ...
                                <Spacer x={1} />
                                <Input
                                    value={directorNameInput.value.value}
                                    onChange={(e) =>
                                        directorNameInput.onChange(
                                            e.target.value,
                                        )
                                    }
                                    helperText={directorNameInput.error.value}
                                    helperColor="error"
                                    placeholder=""
                                    label="Director"
                                    rounded
                                ...
                                <Spacer x={1} />
                                <Input
                                    value={hoursInput.value.value}
                                    onChange={(e) =>
                                        hoursInput.onChange(e.target.value)
                                    }
                                    helperText={hoursInput.error.value}
                                    type="number"
                                    min={0}
                                    max={24}
                                    helperColor="error"
                                ...
                                <Spacer x={1} />
                                <Input
                                    value={minutesInput.value.value}
                                    onChange={(e) =>
                                        minutesInput.onChange(e.target.value)
                                    }
                                    helperText={minutesInput.error.value}
                                    type="number"
                                    min={0}
                                    max={59}
                                    helperColor="error"
                                ...
                                <Spacer x={1} />
                                <Input
                                    value={secondsInput.value.value}
                                    onChange={(e) =>
                                        secondsInput.onChange(e.target.value)
                                    }
                                    helperText={secondsInput.error.value}
                                    type="number"
                                    min={0}
                                    max={59}
                                    helperColor="error"
                                ...
                                <Spacer x={1} />
                                <Input
                                    value={costInput.value.value}
                                    onChange={(e) =>
                                        costInput.onChange(e.target.value)
                                    }
                                    helperText={costInput.error.value}
                                    type="number"
                                    min={0}
                                    helperColor="error"
                                    placeholder=""
                                    label="Producction cost"
                                    rounded
                                    bordered
                                />
                                <Spacer x={1} />
                                <Input
                                    value={earningInput.value.value}
                                    onChange={(e) =>
                                        earningInput.onChange(e.target.value)
                                    }
                                    helperText={earningInput.error.value}
                                    type="number"
                                    min={0}
                                    helperColor="error"
                                    placeholder=""
                                ...
                                />
                                <Spacer x={1} />
                                {Number(earningInput.value.value) <
                                    Number(costInput.value.value) && (
                                    <Text>
                                        The earning is lower than the cost
                                    </Text>
                                )}
                                <Spacer x={1} />
                                <Dropdown>
