...
import {
    ...
    maritialStatuses,
    powerTypes,
} from '../logic/create-villain.logic'
...
import { PowerList } from '../../heroe/application/repositories/heroe.repository'
...
export default function CreateVillainPage() {
    ...
    const {
        ...
        createVillainApplicationService(
