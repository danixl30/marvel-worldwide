...
import { CreateVillainDTO } from './dto/create.dto'
...
import { CreateVillainCommand } from 'src/villain/application/commands/create/create.villain'
...
@ApiTags(VILLAIN_TAG)
export class CreateVillainController
    implements ControllerContract<CreateVillainDTO, CreateVillainResponse>
{
    constructor(
    ...
    async execute(
        @Body() data: CreateVillainDTO,
    ): Promise<CreateVillainResponse> {
        const resp = await new CreateVillainCommand(
