...
export class ErrorDecorator<T, U, E extends ApplicationError> implements ApplicationService<T, U, E> {
    constructor(private service: ApplicationService<T, U, E>, private parser: (error: E) => Error) {}
