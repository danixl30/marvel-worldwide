...
import { CreateSerieDTO } from './dto/create.dto'
...
export class CreateSerieController
    implements ControllerContract<CreateSerieDTO, CreateSerieResponse>
{
    constructor(
    ...
    async execute(@Body() data: CreateSerieDTO): Promise<CreateSerieResponse> {
        const resp = await new CerateSerieCommand(
