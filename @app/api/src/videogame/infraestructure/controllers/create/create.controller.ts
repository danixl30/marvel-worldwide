...
import { CreateVideogameDTO } from './dto/create.dto'
...
import { CreateVideogameCommand } from 'src/videogame/application/commands/create/create.videogame'
...
export class CreateVideogameController
    implements ControllerContract<CreateVideogameDTO, CreateVideogameResponse>
{
    constructor(
    ...
    async execute(
        @Body() data: CreateVideogameDTO,
    ): Promise<CreateVideogameResponse> {
        const resp = await new CreateVideogameCommand(
